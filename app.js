const trip = {
  ...
  days: {
    ...
    day2: {
      ...
      sub: "시장 · 맥주 · 야경",
      events: [
        ["08:30", "해박하 조시 (海泊河早市)", "", "현지 아침시장에서 가볍게 하루를 시작합니다.", "06:00부터 08:30까지 운영하는 이른 시장이라 08:30 일정은 막바지예요.", [120.354, 36.1], "06:00–08:30 · 입장 무료"],
        ...
        ["13:00", "메이다얼 · 식사", "", "중산로 근처에서 점심 식사.", "대기 시간이 있으면 다음 아이스크림 일정과 조정하세요.", [120.32, 36.075], "점심 · 1인 약 ¥30–60"],
